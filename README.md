...
Ενδεικτικός πίνακας από το script στην συστοιχία για v3_cilk με 4 workers και v3_openMP με 4 threads:
...
Ενδεικτικός πίνακας από το script στην συστοιχία για v4_cilk με 4 workers και v4_openMP με 4 threads:
