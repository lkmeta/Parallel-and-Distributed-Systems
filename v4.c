...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    printf("Start counting the triangles with V4 algorithm.\n");
    ...
    for (int i = 0; i < N; ++i)
    {
        for (int j = csc_col[i]; j < csc_col[i + 1]; ++j)
        {
            ...
            for (int k = 0; k < csc_col[Iindex + 1] - csc_col[Iindex]; ++k)
            {
                l1[k] = csc_row[k + csc_col[Iindex]];
            }

            for (int k = 0; k < csc_col[Jindex + 1] - csc_col[Jindex]; ++k)
            {
                l2[k] = csc_row[k + csc_col[Jindex]];
            }
            ...
            */
            ...
            i2 = 0;
            count = 0;
            while ((i1 < csc_col[Iindex + 1] - csc_col[Iindex]) && (i2 < csc_col[Jindex + 1] - csc_col[Jindex]))
            {
                if (l1[i1] == l2[i2])
                {
                    ++count;
