...
echo "Number of workers: 2 4 5 10 15 20 40" >> ./results/v3_cilk.txt
...
echo "Number of threads: 2 4 5 10 15 20 40" >> ./results/v3_openMP.txt
for file in ./matrices/*; do
	printf "\n"
...
echo "Number of workers: 2 4 5 10 15 20 40" >> ./results/v4_cilk.txt
for file in ./matrices/*; do
	printf "\n"
...
echo "Number of threads: 2 4 5 10 15 20 40" >> ./results/v4_openMP.txt
for file in ./matrices/*; do
	printf "\n"
